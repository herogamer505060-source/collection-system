...
color: '#00FFFF'
user-invocable: true
argument-hint: "[component, page, or feature to build]"
---
...
- **React**: Hooks optimization, concurrent rendering, server components
- **Vue**: Composition API, reactivity system, Vue Router
- **Angular**: Signals, standalone components, dependency injection
- **Svelte**: Reactive statements, stores, transitions

### State Management
- Global state patterns (Redux Toolkit, Zustand, Jotai, Pinia)
