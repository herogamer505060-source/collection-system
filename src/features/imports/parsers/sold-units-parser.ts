...
export async function parseSoldUnitsWorkbook(
  ...
  if (!headerRowMatch) {
    throw new Error("Could not find the sold units header row.");
  }
...
export const parseSoldUnitsParser = parseSoldUnitsWorkbook;
